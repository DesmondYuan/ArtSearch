...
docker run --name simplequery -d -p 5000:8081 -e DB_HOST=maindb --mount type=bind,source=/Users/debbieliske/gap_images,target=/gap_images --network appNetwork simplequery
docker run --name maindb -d --mount type=bind,source=/Users/debbieliske/gap_images,target=/gap_images --network appNetwork maindb