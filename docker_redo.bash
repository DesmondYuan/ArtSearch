...
docker run --name simplequery -d -p 5000:8081 -e DB_HOST=maindb --mount type=bind,source=./resource,target=imgs --network appNetwork simplequery
docker run --name maindb -d --mount type=bind,source=./resource,target=imgs --network appNetwork maindb
